...
Definition at line 46 of file authentification.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{46                                                  \{}
\DoxyCodeLine{47     CryptoPP::Weak::MD5 md5;}
\DoxyCodeLine{48     \textcolor{keywordtype}{string} result;}
\DoxyCodeLine{49     ifstream file(fileName);}
\DoxyCodeLine{50     CryptoPP::FileSource(file, \textcolor{keyword}{true}, \textcolor{keyword}{new} CryptoPP::HashFilter(md5, \textcolor{keyword}{new} CryptoPP::StringSink(result)));}
\DoxyCodeLine{51     \textcolor{keywordtype}{string} md5Hex;}
\DoxyCodeLine{52     CryptoPP::StringSource(result, \textcolor{keyword}{true}, \textcolor{keyword}{new} CryptoPP::HexEncoder(\textcolor{keyword}{new} CryptoPP::StringSink(md5Hex), \textcolor{keyword}{false}));}
\DoxyCodeLine{53     \textcolor{keywordflow}{return} md5Hex;}
\DoxyCodeLine{54 \}}
...
Definition at line 62 of file authentification.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{62                             \{}
\DoxyCodeLine{63     \textcolor{keywordflow}{return} md5;}
\DoxyCodeLine{64 \}}
