...
\mbox{\Hypertarget{classmoveBankAuth_a12666b6fc1773dbbaae64f48406c264a}\label{classmoveBankAuth_a12666b6fc1773dbbaae64f48406c264a}} 
\mbox{\hyperlink{classmoveBankAuth_a12666b6fc1773dbbaae64f48406c264a}{$\sim$move\+Bank\+Auth}} ()
\begin{DoxyCompactList}\small\item\em Destructor for \mbox{\hyperlink{classmoveBankAuth}{move\+Bank\+Auth}}. \end{DoxyCompactList}\item 
...
Definition at line 54 of file authentification.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{54                                                  \{}
\DoxyCodeLine{55     CryptoPP::Weak::MD5 md5;}
\DoxyCodeLine{56     \textcolor{keywordtype}{string} result;}
\DoxyCodeLine{57     ifstream file(fileName);}
\DoxyCodeLine{58     CryptoPP::FileSource(file, \textcolor{keyword}{true}, \textcolor{keyword}{new} CryptoPP::HashFilter(md5, \textcolor{keyword}{new} CryptoPP::StringSink(result)));}
\DoxyCodeLine{59     \textcolor{keywordtype}{string} md5Hex;}
\DoxyCodeLine{60     CryptoPP::StringSource(result, \textcolor{keyword}{true}, \textcolor{keyword}{new} CryptoPP::HexEncoder(\textcolor{keyword}{new} CryptoPP::StringSink(md5Hex), \textcolor{keyword}{false}));}
\DoxyCodeLine{61     \textcolor{keywordflow}{return} md5Hex;}
\DoxyCodeLine{62 \}}
...
Definition at line 70 of file authentification.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{70                             \{}
\DoxyCodeLine{71     \textcolor{keywordflow}{return} md5;}
\DoxyCodeLine{72 \}}
